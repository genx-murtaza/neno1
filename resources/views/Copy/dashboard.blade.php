                ...
                <ul class="menu-inner py-1">
                    ...
                    <ul class="menu-sub">
                        ...
                        <a href="auth-register-basic.html" class="menu-link" target="_blank">
                            <div data-i18n="Basic">Users Master</div>
                        </a>
                        </li>
                        <li class="menu-item">
                        <a href="auth-forgot-password-basic.html" class="menu-link" target="_blank">
                            <div data-i18n="Basic">User Permission</div>
                        </a>
                        </li>
                    </ul>
                    </li>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="col-sm-7">
                                <div class="card-body">
                                <h5 class="card-title text-primary">Congratulations {{session()->get('fullname')}}! 🎉</h5>
                                <p class="mb-4">
